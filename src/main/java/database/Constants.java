...
public class Constants {
    ...
    public static Map<String, List<String>> getRolesRights() {
        ...
        ROLES_RIGHTS.get(USER).addAll(Arrays.asList(CREATE_CLIENT, DELETE_CLIENT, UPDATE_CLIENT, CREATE_ACCOUNT, DELETE_ACCOUNT, UPDATE_ACCOUNT, MAKE_TRANSFER, PAY_BILL));
